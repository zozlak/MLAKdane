...
oblicz_zmienne_pochodne = function(dane, multidplyr = TRUE){
  ...
  dane = dane %>%
    mutate_(
      ...
      pm_bd_n = ~dplyr::coalesce(100L * nm_bd_n / nm_n, NA_real_),
      pm_bd_s = ~dplyr::coalesce(100L * nm_bd_s / nm_s, NA_real_),
      ...
      pm_d_n  = ~dplyr::coalesce(100L * nm_d_n / nm_n, NA_real_),
      pm_d_s  = ~dplyr::coalesce(100L * nm_d_s / nm_s, NA_real_),
      pm_e    = ~dplyr::coalesce(100L * nm_e / len, NA_real_),
      pm_e_n  = ~dplyr::coalesce(100L * nm_e_n / nm_n, NA_real_),
      pm_e_s  = ~dplyr::coalesce(100L * nm_e_s / nm_s, NA_real_),
      pm_i    = ~dplyr::coalesce(100L * nm_i / len, NA_real_),
      pm_i_n  = ~dplyr::coalesce(100L * nm_i_n / nm_n, NA_real_),
      pm_i_s  = ~dplyr::coalesce(100L * nm_i_s / nm_s, NA_real_),
      pm_n    = ~dplyr::coalesce(100L * nm_n / len, NA_real_),
      pm_n_n  = ~dplyr::coalesce(100L * nm_n_n / nm_n, NA_real_),
      pm_n_s  = ~dplyr::coalesce(100L * nm_n_s / nm_s, NA_real_),
      pm_p    = ~dplyr::coalesce(100L * nm_p / len, NA_real_),
      pm_p_n  = ~dplyr::coalesce(100L * nm_p_n / nm_n, NA_real_),
      pm_p_s  = ~dplyr::coalesce(100L * nm_p_s / nm_s, NA_real_),
      pm_s    = ~dplyr::coalesce(100L * nm_s / len, NA_real_),
      pm_s_n  = ~dplyr::coalesce(100L * nm_s_n / nm_n, NA_real_),
      pm_s_s  = ~dplyr::coalesce(100L * nm_s_s / nm_s, NA_real_),
      pm_x_n  = ~dplyr::coalesce(100L * nm_x_n / nm_n, NA_real_),
      pm_x_s  = ~dplyr::coalesce(100L * nm_x_s / nm_s, NA_real_),
