...
library(MLAK)
devtools::load_all(".")
wszystkoS = wczytajDane('../dane/archiwum/2016-09_2015_0.8.0.RData')
miesieczneS = wczytajDane('../dane/archiwum/2016-09_2015_0.8.0_mies.RData')
miesieczneS = miesieczneS %>% rename(ID_ZDAU = ID_ZDAU_M, OKRES = OKRES_M) %>% semi_join(wszystkoS %>% select(ID_ZDAU))
wszystko = wczytajDane('../dane/ZUS_2016-09/2014/2014_dane.RData')
